...
- [HowTo (MD)](en/manuals/md/howto.md)
- [Features (MD)](en/manuals/md/features.md)
- [Hardware (MD)](en/manuals/md/hardware.md)
- [Multi-network (MD)](en/manuals/md/multi-net.md)
- [REST API (MD)](en/manuals/md/api-rest.md)
- [SRT → UDP/RTP for cable headends (MD)](en/manuals/md/srt-to-udp-rtp-cable-headends.md)

### Español (MD)
- [Instalación (MD)](es/manuales/md/installacion.md)
- [HowTo (MD)](es/manuales/md/howto.md)
- [Características (MD)](es/manuales/md/features.md)
- [Hardware (MD)](es/manuales/md/hardware.md)
- [Multi-net (MD)](es/manuales/md/multi-net.md)
- [API REST (MD)](es/manuales/md/api-rest.md)
- [SRT → UDP/RTP para cabeceras (MD)](es/manuales/md/srt-to-udp-rtp-cable-headends.md)

---

## PDF manuals (original)
### English (PDF)
- [INSTALL_ENG.pdf](en/manuals/pdf/INSTALL_ENG.pdf)
- [HOWTO_ENG.pdf](en/manuals/pdf/HOWTO_ENG.pdf)
...
### Español (PDF)
- [INSTALL_SPA.pdf](es/manuales/pdf/INSTALL_SPA.pdf)
- [HOWTO_SPA.pdf](es/manuales/pdf/HOWTO_SPA.pdf)
- [FEATURES_SPA.pdf](es/manuales/pdf/FEATURES_SPA.pdf)
- [HARDWARE_SPA.pdf](es/manuales/pdf/HARDWARE_SPA.pdf)
