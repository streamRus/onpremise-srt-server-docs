...
- [Ejemplo cabecera (SRT → UDP/RTP multicast)](headend-srt-to-udp-rtp.md)
- [Instalación multired (varias NIC)](multi-net.md)

## Operación y automatización
- [API REST (Swagger)](api.md)
- [Operación: backup/restore y actualizaciones](operations.md)

## HOWTO
- [HOWTO: Streams (flujo básico)](howto-streams.md)
- [HOWTO: Inputs](howto-inputs.md)
- [HOWTO: Outputs](howto-outputs.md)

## Referencia
- [Características (alto nivel)](features.md)
